...
if len(sys.argv) != 3:
    sys.stdout.write('ERROR - usage: python3 conv2unint8-ww.py INPUT_IMAGE_FOLDER OUTPUT_IMAGE_FOLDER \n')
    exit(0)
...
def processInput(x):
    ...
    cmd = 'convert -auto-level -depth 8 -normalize '+file_in+' '+file_out
