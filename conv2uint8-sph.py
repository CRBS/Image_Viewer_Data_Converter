...
sys.stdout.write('Removing ' + str(cutperc1) + ' percentile of grey values \n')
...
def processInput(x):
    ...
    image = skimage.exposure.rescale_intensity(img_float64, in_range=(np.percentile(img_float64, cutperc1), np.percentile(img_float64, 100-cutperc2)), out_range=(0.3, 0.7))
